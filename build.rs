...
fn main() {
    ...
    println!("cargo:rerun-if-changed=asm/cortex_m0_curve25519.S");
    ...
    println!("cargo:rerun-if-changed=asm/cortex_m_keccak.S");
    println!("cargo:rerun-if-changed=asm/cortex_m_mlkem.S");
    println!("cargo:rerun-if-changed=asm/cortex_m_mldsa.S");
    println!("cargo:rerun-if-changed=asm/cortex_m_sha512.S");
    println!("cargo:rerun-if-changed=asm/cortex_m_ghash.S");
