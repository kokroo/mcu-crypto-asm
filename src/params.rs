...
pub mod p256 {
    ...
    pub const R3_MONT: [u32; 8] = [
        0x0000000a, 0xfffffffd, 0xfffffff7, 0xffffffed, 0xfffffffc, 0x00000005, 0x00000001,
        0x00000018,
    ];
...
pub mod p384 {
    ...
    pub const R2_MONT: [u32; 12] = [
        0x00000001, 0xfffffffe, 0x00000000, 0x00000002, 0x00000000, 0xfffffffe, 0x00000000,
        0x00000002, 0x00000001, 0x00000000, 0x00000000, 0x00000000,
    ];

    /// R^3 mod p. Used by Montgomery inversion.
    pub const R3_MONT: [u32; 12] = [
        0x00000002, 0xfffffffc, 0x00000002, 0x00000003, 0xfffffffe, 0xfffffffc, 0x00000005,
        0x00000003, 0xfffffffd, 0xfffffffd, 0x00000002, 0x00000003,
    ];
